...
export const App = () => {
  ...
  const [safeOption, setSafeOption] = useState(10);
  ...
  const submit = () => {
    window.gtag('event', 'Buy_insurance_4113_click_var1');
    ...
    <>
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          ...
          view="primary"
          onClick={() => {
            window.gtag('event', 'Buy_main_4113_click_var1');
            setShowBs(true);
          }}
        >
          Купить
      ...
      >
        <div className={appSt.container}>
          ...
          <Switch
            ...
            onChange={() => {
              window.gtag('event', 'insurance_4113_click_var1');
